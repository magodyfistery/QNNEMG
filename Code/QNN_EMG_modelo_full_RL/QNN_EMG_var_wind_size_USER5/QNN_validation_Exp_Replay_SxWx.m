...
for experiment_id=experiment_begin:experiment_end
    ...
    for index_window=1:numel(windows_sizes)
        ...
        for index_stride=1:numel(strides)
            ...
            RepTraining        =  13;% parameters_validation(experiment_id, index_RepTraining);       %numero de muestras que voy a usar en el entrenamiento x cada usuario en la carpeta C:\Users\juanp\Desktop\QNN - EMG - RandomData - Copy\Data\Specific
