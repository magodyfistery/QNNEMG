...
set instruction="try; actual_dir=pwd; cd(actual_dir+string('/%execute_from_folder%'));  QNN_train_emg_Exp_Replay_SxWx(%inicio%, 29, 29, true, false, %window_sizes%, %strides%, %numEpochs%); catch ME; disp(ME); end;"
