function test_accuracy = QNN_TESTING_Exp_Replay(new_rangeDown, params, verbose)
...
assignin('base','WindowsSize',  params.window_size);   %CAMBIAR - 200


%%%%PARAMETRIZACION_DANNY%%%%
assignin('base','Stride',  params.stride);        %CAMBIAR - 20
RepTraining        = 25;       %numero de muestras que voy a usar en el entrenamiento x cada usuario en la carpeta C:\Users\juanp\Desktop\QNN - EMG - RandomData - Copy\Data\Specific
...
test_accuracy = recognition_accuracy + clasification_accuracy + win_per_window_accuracy;
