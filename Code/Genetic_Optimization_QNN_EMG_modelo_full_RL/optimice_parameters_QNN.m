function optimice_parameters_QNN(verbose_level, generations, ...
    max_population, num_parents_to_select, gens_set)
...
% generations = 30;  % its just a stop step in case the program cant find solution
