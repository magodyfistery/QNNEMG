...
%%
root_ = pwd;
from_dir = horzcat(root_,'\TrainingData\');
to_dir   = horzcat(root_,'\Data\General\training');
...
root_ = pwd;
from_dir = horzcat(root_,'\TestingData\');
to_dir   = horzcat(root_,'\Data\General\testing');
copyfile(from_dir,to_dir);

to_dir   = horzcat(root_,'\Data\Specific');
copyfile(from_dir,to_dir);
