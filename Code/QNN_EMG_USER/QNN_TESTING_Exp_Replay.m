...
RepTraining        = 1;       %numero de muestras que voy a usar en el entrenamiento x cada usuario en la carpeta C:\Users\juanp\Desktop\QNN - EMG - RandomData - Copy\Data\Specific
...
test_accuracy = summary(2)/(summary(2) + summary(5)) + summary(3)/(summary(3) + summary(6));
