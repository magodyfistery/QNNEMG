function new_begin_row = write_excel_training_base(filename_experimentsQNN, USER_ID, row_position)
...
while should_write 
	...
	try 
		...
		writecell({"TRAINING RESULTS"}, filename_experimentsQNN,'Sheet',SHEET_NAME,'Range',"N"+new_begin_row);
