function new_begin_row = write_experiment_row(filename_experimentsQNN, experiment_parameters, row_position, summary, experiment_id, USER_ID)
...
while should_write 
	...
	try 
		...
		writetable(table_row, filename_experimentsQNN,'Sheet', SHEET_NAME,'Range', "A"+new_begin_row,'WriteVariableNames',false);
